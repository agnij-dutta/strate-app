      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="relative flex max-h-[calc(100dvh-2rem)] w-full max-w-[540px] flex-col border border-parchment/14 bg-ink shadow-panel"
            style={{ borderRadius: 2 }}
            role="dialog"
            aria-modal="true"
            aria-labelledby="disclaimer-title"
          >
            <div className="shrink-0 border-b border-parchment/10 px-7 py-5">
            ...
            <div className="min-h-0 flex-1 overflow-y-auto px-7 py-6">
              ...
              >
                ...
                this tab. There is no waitlist gating mainnet. Deposit
                only what you can afford to lose.
              </p>
            </div>

            <div className="flex shrink-0 items-center justify-between gap-4 border-t border-parchment/10 px-7 py-4">
              <a
